...
const zhToEn: Record<string, string> = {
  ...
  总流量: 'Total traffic',
  总实时流量: 'Total realtime traffic',
  入站累计流量: 'Inbound cumulative traffic',
  入站实时流量: 'Inbound realtime traffic',
  客户端累计流量: 'Client cumulative traffic',
  客户端实时流量: 'Client realtime traffic',
  采样时间: 'Sampled at',
  采样窗口: 'Sample window',
  入站原生统计: 'Native inbound stats',
  客户端原生统计: 'Native client stats',
  客户端汇总回退: 'Client aggregate fallback',
  混合来源: 'Mixed sources',
  '重置累计不会改写历史趋势': 'Resetting cumulative usage does not rewrite historical trends',
  客户端: 'Clients',
  ...
  流量分析加载失败: 'Failed to load traffic analytics',
  流量分析加载中: 'Loading traffic analytics',
  ...
  'Top 入站': 'Top inbounds',
  暂无数据: 'No data',
  至少需要采样数据后才能绘制趋势: 'Traffic samples are required before drawing the trend',
  生成中: 'Generating',
  ...
  '搜索节点、客户端、协议、端口...': 'Search nodes, clients, protocols, ports...',
  全部协议: 'All protocols',
  全部状态: 'All statuses',
  需关注: 'Needs attention',
  展开全部客户端: 'Expand all clients',
  收起全部客户端: 'Collapse all clients',
  搜索命中的客户端已自动展开: 'Matched clients are expanded automatically',
  ...
  实时统计不可用: 'Realtime stats unavailable',
  统计覆盖不完整: 'Stats coverage incomplete',
  部分统计不可用: 'Some stats unavailable',
  统计已过期: 'Stats stale',
  核心节点未配置: 'Core node not configured',
  ...
  公开访问地址: 'Public address',
  '填写域名即可，例如 migate.526566.xyz；保存时会自动拼接 Web 基础路径。': 'Enter only the domain, for example migate.526566.xyz. The Web base path is appended automatically when saved.',
  未设置公开访问地址: 'Public address not configured',
  信任反向代理请求头: 'Trust reverse proxy headers',
  '启用后正确识别 HTTPS 代理并设置安全登录 Cookie。': 'Recognize HTTPS proxies and set secure login cookies when enabled.',
  数据库路径: 'Database path',
  ...
  '设置已保存，端口、数据库、基础路径或反向代理配置变更需要重启服务后生效': 'Settings saved. Port, database, base path, or reverse proxy changes require a service restart.',
